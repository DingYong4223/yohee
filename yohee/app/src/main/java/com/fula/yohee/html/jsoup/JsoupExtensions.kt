...
package com.fula.yohee.html.jsoup
...
inline fun Document.head(build: Element.() -> Unit) {
    build(head())
}
...
//inline fun Document.marks(provide: () -> String) {
//    this.title(provide())
//}
...
inline fun Element.id(id: String, build: Element.() -> Unit): Element {
    return getElementById(id).also(build)
}
