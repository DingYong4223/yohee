package com.fula.yohee.search.suggestions

import com.fula.yohee.database.SearchSuggestion
import com.fula.yohee.extensions.safeUse
...
abstract class BaseSuggestionsModel internal constructor(
    ...
    override fun resultsForSearch(rawQuery: String): Single<List<SearchSuggestion>> = Single.fromCallable {
        val query = try {
            ...
            CLog.i("error, Unable to encode the URL")
    ...
    private fun downloadSuggestionsForQuery(query: String, language: String): Response? {
        ...
        return try {
            ...
            CLog.i("error, Problem getting search suggestions")
            null
        }
    }
