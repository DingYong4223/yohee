...
import com.fula.downloader.file.DefaultStorageEngine;
import com.fula.downloader.file.Extra;
import com.fula.downloader.file.StorageEngine;
 ...
 * @since 1.0.0
 */
public final class DownRuntime {

    private static final DownRuntime sInstance = new DownRuntime();
    ...
    public static DownRuntime getInstance() {
        return sInstance;
    }
    ...
    private void createDefaultDownloadTask() {
        ...
        sDefaultDownloadTask.mIsBreakPointDownload = true;
        sDefaultDownloadTask.mDownloadIcon = android.R.drawable.stat_sys_download;
        sDefaultDownloadTask.blockMaxTime = 10 * 60 * 1000;
        sDefaultDownloadTask.downloadTimeOut = Long.MAX_VALUE;
        sDefaultDownloadTask.mIsParallelDownload = true;
        sDefaultDownloadTask.mAutoOpen = false;
        sDefaultDownloadTask.mIsForceDownload = true;
        sDefaultDownloadTask.setConnectTimeOut(6000)
    ...
    public String getFileNameByContentDisposition(String contentDisposition) {
    ...
    public File uniqueFile(@NonNull DownloadTask downloadTask, @Nullable File targetDir) {
        ...
        File dir = (targetDir == null || !targetDir.isDirectory()) ? getInstance().getDir(downloadTask.getContext(), downloadTask.isEnableIndicator()) : targetDir;
    ...
    public Intent getCommonFileIntentCompat(Context context, DownloadTask downloadTask) {
        ...
        setIntentDataAndType(context, mIntent, getMIMEType(downloadTask.mFile), downloadTask.mFile, false, downloadTask.isCustomFile ? downloadTask.authority : getAuthority(downloadTask.getContext()));
        return mIntent;
    }
    ...
    public String getMIMEType(File f) {
        ...
        if (end.equals("pdf")) {
            ...
            type = "audio/*";
        } else if (UrlUtils.isVideo(fName)) {
            type = "video/*";
        } else if (UrlUtils.isImage(fName)) {
            type = "image/*";
