...
public class FloatingActionMenu extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mShowMenu = attr.getBoolean(R.styleable.FloatingActionMenu_menu_showMenu, true);
    ...
    private void createMenuButton() {
        ...
        mMenuButton.setVisibility(mShowMenu ? View.VISIBLE : View.INVISIBLE);
