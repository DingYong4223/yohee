...
import com.fula.fano.AbstractUnitTest
...
/**
 * Unit tests for [FilterSupportedElement].
 */
class FilterSupportedElementTest : AbstractUnitTest() {
    ...
    fun test_VariedElementKind() {
        ...
        ElementKind.values()
                ...
                .forEach {
                    ...
                    Assertions.assertThat(FilterSupportedElement.invoke(mockElement)).isFalse()
                }
        ...
        // Verify
        Assertions.assertThat(FilterSupportedElement.invoke(mockElement)).isTrue()
    }
