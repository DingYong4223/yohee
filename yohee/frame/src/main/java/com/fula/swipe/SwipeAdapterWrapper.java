    ...
    public final void onBindViewHolder(RecyclerView.ViewHolder holder, int position, List<Object> payloads) {
        ...
        if (itemView instanceof SwipeMenuLayout) {
            ...
            if (leftMenu.hasMenuItems()) {
                ...
                menuView.createMenu(holder, leftMenu, menuLayout, SwipeMenuRecyclerView.LEFT_DIRECTION, mSwipeMenuItemClickListener);
            }
            ...
            if (rightMenu.hasMenuItems()) {
                ...
                menuView.createMenu(holder, rightMenu, menuLayout, SwipeMenuRecyclerView.RIGHT_DIRECTION, mSwipeMenuItemClickListener);
            }
        }
