...
public class GSYSurfaceView extends SurfaceView implements SurfaceHolder.Callback2, IGSYRenderView, MeasureHelper.MeasureFormVideoParamsListener {
    ...
    public Bitmap initCover() {
        CLog.i(getClass().getSimpleName() + " not support initCover now");
        return null;
    }

    @Override
    public Bitmap initCoverHigh() {
        CLog.i(getClass().getSimpleName() + " not support initCoverHigh now");
        return null;
    }
    ...
    public void taskShotPic(GSYVideoShotListener gsyVideoShotListener, boolean shotHigh) {
        CLog.i(getClass().getSimpleName() + " not support taskShotPic now");
    }
    ...
    public void saveFrame(final File file, final boolean high, final GSYVideoShotSaveListener gsyVideoShotSaveListener) {
        CLog.i(getClass().getSimpleName() + " not support saveFrame now");
    }
    ...
    public void onRenderResume() {
        CLog.i(getClass().getSimpleName() + " not support onRenderResume now");
    }

    @Override
    public void onRenderPause() {
        CLog.i(getClass().getSimpleName() + " not support onRenderPause now");
    }

    @Override
    public void releaseRenderAll() {
        CLog.i(getClass().getSimpleName() + " not support releaseRenderAll now");
    }

    @Override
    public void setRenderMode(int mode) {
        CLog.i(getClass().getSimpleName() + " not support setRenderMode now");
    }


    @Override
    public void setRenderTransform(Matrix transform) {
        CLog.i(getClass().getSimpleName() + " not support setRenderTransform now");
    }

    @Override
    public void setGLRenderer(GSYVideoGLViewBaseRender renderer) {
        CLog.i(getClass().getSimpleName() + " not support setGLRenderer now");
    }

    @Override
    public void setGLMVPMatrix(float[] MVPMatrix) {
        CLog.i(getClass().getSimpleName() + " not support setGLMVPMatrix now");
    }
    ...
    public void setGLEffectFilter(GSYVideoGLView.ShaderInterface effectFilter) {
        CLog.i(getClass().getSimpleName() + " not support setGLEffectFilter now");
    }
