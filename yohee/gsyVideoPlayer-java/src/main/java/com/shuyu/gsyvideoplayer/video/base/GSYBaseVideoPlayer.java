...
public abstract class GSYBaseVideoPlayer extends GSYVideoControlView {
    ...
    protected boolean isVerticalVideo() {
        ...
        CLog.i("videoHeight " + videoHeight + " videoWidth " + videoWidth + "mRotate: " + mRotate);
    ...
    protected void checkAutoFullSizeWhenFull() {
        if (mIfCurrentIsFullscreen) {
            ...
            CLog.i("GSYVideoBase onPrepared isVerticalFullByVideoSize " + isV);
            if (isV) {
                if (mOrientationUtils != null)
